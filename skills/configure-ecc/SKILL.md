...
2. **Manual**: Copy only this skill to `~/.factory/skills/configure-ecc/SKILL.md`, then activate by saying "configure ecc"
...
Options:
  - "User-level (~/.factory/)" — "Applies to all your Claude Code projects"
...
- If a skill references `~/.factory/skills/` or `~/.factory/skills/` — this may be broken if installed only at project level
