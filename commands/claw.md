...
2. Loads conversation history from `~/.factory/claw/{session}.md`
...
Sessions are stored as Markdown files in `~/.factory/claw/`:

```
~/.factory/claw/default.md
~/.factory/claw/my-project.md
```
