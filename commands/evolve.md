...
```bash
python3 "${DROID_PLUGIN_ROOT}/skills/continuous-learning-v2/scripts/instinct-cli.py" evolve [--generate]
```

Or if `DROID_PLUGIN_ROOT` is not set (manual installation):
...
1. Read all instincts from `~/.factory/homunculus/instincts/`
...
3. For each cluster of 3+ related instincts:
   ...
   - Save to `~/.factory/homunculus/evolved/{commands,skills,agents}/`
...
Files:
  - ~/.factory/homunculus/evolved/agents/debugger.md
